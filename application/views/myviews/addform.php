                        ...
                        <div class="panel-content">
                            <div class="row">
                                <div class="col-md-12">                                    
                                    ...
                                    <form id="inline-validation" class="form-horizontal form-stripe" action="<?php if(isset($info->eid)) echo site_url('Op_Controller/updateSQL');else echo site_url('Op_Controller/add'); ?>" method="POST">
                                        <div class="form-group">
                                            <label for="name" class="col-sm-3 control-label">员工号<span class="required">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="eid" name="eid" value="<?php if (isset($info->eid)) {echo $info->eid;}?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="name" name="name" value="<?php if (isset($info->eid)) {echo $info->name;}?>" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="sex" id="sex" value="男" <?php if (isset($info->eid)&&$info->sex=='男') {echo 'checked';}?> >男
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="sex" id="sex" value="女"  <?php if (isset($info->eid)&&$info->sex=='女') {echo 'checked';}?>>女
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="email" class="form-control" id="email" name="email"  value="<?php if (isset($info->eid)) {echo $info->email;}?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="password" class="col-sm-3 control-label">联系电话<span class="required">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="phone" name="phone"   value="<?php if (isset($info->eid)) {echo $info->phone;}?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="password" class="col-sm-3 control-label">年龄<span class="required">*</span></label>
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="age" name="age"  value="<?php if (isset($info->eid)) {echo $info->age;}?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="cofirmation" class="col-sm-3 control-label">部门<span class="required">*</span></label>
                                                <div class="col-sm-5">
                                                 <div class="radio">
                                                    <label>
                                                        <input type="radio" name="department" id="department" value="1"  onclick="switchItem('1')" <?php if (isset($info->eid)&&$info->d_id==1) {echo 'checked';}?>>董事会
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="department" id="department" value="2"  onclick="switchItem('2')" <?php if (isset($info->eid)&&$info->d_id==2) {echo 'checked';}?>>市场部
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="department" id="department" value="3"  onclick="switchItem('3')" <?php if (isset($info->eid)&&$info->d_id==3) {echo 'checked';}?>>研发部
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="department" id="department" value="4"  onclick="switchItem('4')" <?php if (isset($info->eid)&&$info->d_id==4) {echo 'checked';}?>>营销部
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label>
                                                        <input type="radio" name="department" id="department" value="5"  onclick="switchItem('5')" <?php if (isset($info->eid)&&$info->d_id==5) {echo 'checked';}?>>网络部
                                                    </label>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" id="salary" name="salary" value="<?php if (isset($info->eid)) {echo $info->salary;}?>" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <div class="input-group mt-sm mb-sm">
                                                ...
                                                <input type="text" class="form-control" id="date-mask" placeholder="dd/mm/yyyy" name="indate" value="<?php if (isset($info->eid)) {echo $info->indate;}?>" >
                                            </div>
                                        </div>
