                ...
                <div class="nano-content">
                    <nav>
                        <ul class="nav" id="main-nav">
                            <li class="active-item"><a href="<?php echo 'index.php/Controller1/getDBview'?>"><i class="fa fa-home" aria-hidden="true"></i><span>主面板</span></a></li>
                            ...
                            <li class="has-child-item close-item">
                                ...
                                <ul class="nav child-nav level-1">
                                    <li><a href="<?php echo 'index.php/Op_Controller/form'?>">人员增加</a></li>
                            ...
                            <li class="has-child-item close-item">
                                ...
                                <ul class="nav child-nav level-1">
                                    <li><a href="<?php echo 'index.php/Controller1/table'?>">员工基本信息表</a></li>
